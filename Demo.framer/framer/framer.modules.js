...
var defaults, error, framerDevices, layoutAlign, layoutChange, layoutSize, onResize, screen, setProps, textAutoSize;
...
textAutoSize = function(textLayer) {
  var styles, textWidth;
  if (textLayer.constraints) {
    print(textLayer.constraints);
    this.constraints = {};
    if (textLayer.constraints.height) {
      this.constraints.height = textLayer.constraints.height;
    }
    if (textLayer.constraints.width) {
      this.constraints.width = textLayer.constraints.width;
    }
  }
  styles = {
  ...
  textWidth = Utils.textSize(textLayer.html, styles, this.constraints);
  return {
